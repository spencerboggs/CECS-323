...
def main():
    fetch_file = input('Do you want to fetch the file? \n(You can only do this if you create .env and specify API_TOKEN) (y/N): ')
    if fetch_file.lower() == 'y':
        fetchcsv.main()
    try:
        data = read_csv()
    except FileNotFoundError:
        print('File not found. Please fetch / download the file first. \nMake sure to run this program from the directory with data.csv')
        sys.exit(1)
